...
Scenario: Update a Product
    ...
    And I press the "Search" button
    Then I should see the message "Success"
    When I set the "Name" to "Cap"
    And I set the "Description" to "A blue fedora Cap"
    ...
    Then I should see "Cap" in the "Name" field
    And I should see "A blue fedora cap" in the "Description" field
